...
export function HistoryPanel({
  ...
  // This is the standard form for getting a function or attribute from the store
  // we reference the current state of the store
                ...
                <div key={date}>
                  ...
                  {items.map((item) => (
                    <HistoryItem
                      ...
                      onPlay={() => handlePlayHistoryItem(item)}
                    />
                  ))}
                </div>
              ))
    ...
    >
      <div className="flex w-full flex-col gap-1">
        <div className="relative w-full">
          ...
          {hoveredItem === item.id && (
            <div className="absolute right-0 flex items-center gap-1 bg-gray-100 pl-2">
              <button
                onClick={() => onPlay(item)}
